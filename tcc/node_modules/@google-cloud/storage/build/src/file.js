...
class File extends nodejs_common_1.ServiceObject {
    ...
    createReadStream(options = {}) {
        ...
        const throughStream = new util_2.PassThroughShim();
        let crc32c = true;
        let md5 = false;
        ...
        const makeRequest = () => {
            ...
            if (options[util_1.GCCL_GCS_CMD_KEY]) {
                reqOpts[util_1.GCCL_GCS_CMD_KEY] = options[util_1.GCCL_GCS_CMD_KEY];
            }
    ...
    createResumableUpload(optionsOrCallback, callback) {
        ...
        resumableUpload.createURI({
            ...
            [util_1.GCCL_GCS_CMD_KEY]: options[util_1.GCCL_GCS_CMD_KEY],
        }, callback);
        this.storage.retryOptions.autoRetry = this.instanceRetryValue;
    }
    /**
    ...
    createWriteStream(options = {}) {
        ...
        const emitStream = new util_2.PassThroughShim();
    ...
    generateSignedPostPolicyV2(optionsOrCallback, cb) {
        const args = (0, util_2.normalize)(optionsOrCallback, cb);
    ...
    generateSignedPostPolicyV4(optionsOrCallback, cb) {
        ...
        const now = new Date();
        const nowISO = (0, util_2.formatAsUTCISO)(now, true);
        const todayISO = (0, util_2.formatAsUTCISO)(now);
        const sign = async () => {
            ...
            const expiration = (0, util_2.formatAsUTCISO)(expires, true, '-', ':');
            const policy = {
                conditions,
                expiration,
            };
            const policyString = (0, util_2.unicodeJSONStringify)(policy);
            const policyBase64 = Buffer.from(policyString).toString('base64');
            try {
    ...
    getSignedUrl(cfg, callback) {
        ...
        const extensionHeaders = (0, util_2.objectKeyToLowercase)(cfg.extensionHeaders || {});
